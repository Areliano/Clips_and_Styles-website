      ...
      <div className="accordion flex flex-col justify-center items-center">
        ...
        <div className="items w-[75%]">
          <details
            ...
            open
          >
            <summary className="text-[16px] md:text-[18px] font-semibold flex justify-between items-center">
          ...
          >
            ...
            <p className="text-[14px] md:text-[16px] font-mediumtext-neutral-700">
          ...
          >
            ...
            <p className="text-[14px] md:text-[16px] font-medium text-neutral-700">
